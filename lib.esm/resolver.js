import { encodeBase58, encodeBase64, toUtf8String } from 'ethers';
import { configureResolverWithNetworks } from './configuration.js';
import { Errors, eventNames, identifierMatcher, interpretIdentifier, legacyAlgoMap, legacyAttrTypes, nullAddress, strip0x, verificationMethodTypes, } from './helpers.js';
