import { concat, encodeBytes32String, getBytes, hexlify, isHexString, keccak256, toBeHex, toUtf8Bytes, zeroPadValue, } from 'ethers';
import { getContractForNetwork } from './configuration.js';
import { DEFAULT_REGISTRY_ADDRESS, interpretIdentifier, MESSAGE_PREFIX, stringToBytes32, } from './helpers.js';
/**
